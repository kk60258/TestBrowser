...
import org.mozilla.materialfennec.logger.BaseLoggerFactory;

public class Logger {
    private static org.mozilla.materialfennec.logger.BaseLoggerBase STATIC_LOGGER = BaseLoggerFactory.getLogger("jasonlai");
